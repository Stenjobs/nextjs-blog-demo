...
export default function Profile({slatData,getUserSlat}) {
    ...
    return <div className="animate__animated animate__fadeInDown p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col justify-center items-center backdrop-blur-md bg-white/50 border border-white/20">
        <div className="flex justify-between items-center mb-4 w-full">
            ...
            >
                <svg className="w-4 h-4 text-gray-500 refresh-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex gap-4 w-full justify-center">
            <div className="text-center">
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold">{slatData.totalPosts || 0}</span>
                </div>
            ...
            <div className="text-center">
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold">{slatData.totalLikes || 0}</span>
                </div>
            ...
            <div className="text-center">
                <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold">{slatData.totalStars || 0}</span>
                </div>
